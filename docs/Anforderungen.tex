...
\newpage
    ...
    \section{Anwendungsfalldiagramm:}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=\linewidth]{Sources/UseCase_MadBalls.png}
...
.3 design/.
.3 sanity-checks/.
.4 sanity\_check\_code/.
.4 SanityCheck\_JavaFX.pdf.
.4 SanityCheck\_Jbox2d.pdf.
.3 Anforderungsdokument.pdf.
.3 Anforderungen.tex.
.3 MadBalls\_Features.pdf.
.3 MadBalls\_StoryCards.pdf.
.3 MB\_Gantt-Diagramm.png.
.3 OpenIssueReport.pdf.
.2 src/.
.3 main/.
.4 java/.
.5 mm/.
...
.2 README.md. 
    ...
    \section{Architektur:}
        Wie in der Ordnerstruktur sichtbar folgt unser Projekt dem Model-View-Controller-Pattern, in dem in View-Directory alle View-Klassen sind, die Graphische Oberflächen erstellen. Im Model-Directory werden alle Klassen, die auf den Leveldaten arbeiten und/oder Simulationslogik definieren, erstellt. In Controller werden die einzelnen Model-Klassen und View-Klassen kontrolliert. Die Logik die die Models mit Views verknüpft und Datenfluss ermöglicht ist auch im Controller-Directory zu finden. 
