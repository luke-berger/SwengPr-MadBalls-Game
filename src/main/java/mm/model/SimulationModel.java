 ...
 * <p>
 * This class is responsible for managing the simulation's data, including the physics world,
 * game objects, inventory, and simulation state. It provides methods to initialize the simulation,
 * manage inventory and dropped objects, export the current level, and handle collision events.
 * <br>
 * <b>Note:</b> This class does not contain any UI or event handling code; it is intended to be used
 * as the Model in an MVC architecture.
 * </p>
 *
 * <h3>Responsibilities:</h3>
 * <ul>
 *   <li>Loading and initializing the physics world and game objects from a level file</li>
...
public class SimulationModel {
     ...
     */
    public List<PhysicsVisualPair> getPairs() { return pairs; }
     ...
     */
    public List<PhysicsVisualPair> getNoPlaceZones() { return noPlaceZones; }
     ...
     */
    public void setPairs(List<PhysicsVisualPair> pairs) { this.pairs = pairs; }
     ...
     * @param noPlaceZones the list of PhysicsVisualPair objects to set as no-place zones
     */
    public void setNoPlaceZones(List<PhysicsVisualPair> noPlaceZones) { this.noPlaceZones = noPlaceZones; }
     ...
     */
    public void setLevelPath(String levelPath) { this.levelPath = levelPath; }

    /**
     * Loads the level and initializes the physics world and objects.
     * <p>
     * This method creates a new physics world, loads game objects from the level file,
     * converts them to physics-visual pairs, and sets up no-place zones and the animation timer.
     * It also adds any previously dropped objects and sets up the contact listener for win conditions.
     * </p>
     */
     ...
     * <p>
     * This listener checks for win conditions, such as the ball reaching the win platform or zone.
     * </p>
     */
